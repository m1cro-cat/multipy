...
def info():
	print(f"\nПрограмма MultiPy.\nВерсия {current_version} {release_type} от {version_date}.\nТакже ОГРОМНОЕ спасибо MystieHum и Claude(ChatGPT) за помощь в некоторых командах и моментах. \nНе все я здесь писал сам. Нейросеть написала примерно 15% кода.")
