current_version = "3.1.4.4"
version_date = "23.08.23"
...
def convertor():
            ...
            while ipt != "0":
                ...
                if ipt == "байты - кб":
                    ...
                    per1 = int(input("Введите байты: "))
                    print("Итог трудов программы:", per1 / 1024**2)  
                elif ipt == "байты - гб":
                    per1 = int(input("Введите байты: "))
                    print("Итог трудов программы:", per1 / 1024**3)
                elif ipt == "байты - тб":
                    per1 = int(input("Введите байты: "))
                    print("Итог трудов программы:", per1 / 1024**4)
